...
Do download the `.iso` file(s), either directly or through your favorite download mechanism (example: torrent); and also do download the CheckSum file to verify that the downloaded `.iso` file is intact (not corrupted).
